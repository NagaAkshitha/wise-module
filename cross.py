...
Viewed 12876 times
Revision 2 (updated 5 years ago)
Enterprise and Business Editions, Commercial Support, Consulting, Training for Developing Critical Applicationsimport sys
def read_board(board_filename):
	bd = []
	for line in open(board_filename):
		bd.append(line.strip())
...
Viewed 12876 times
Revision 2 (updated 5 years ago)
Enterprise and Business Editions, Commercial Support, Consulting, Training for Developing Critical Applications
